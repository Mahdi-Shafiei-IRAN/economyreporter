...
## خواسته‌های بعدی کاربر (ثبت‌شده تا فراموش نشود)
- ⬜ **نوتیفیکیشن + دسته‌بندی خودکار:** بعد از تراکنش نوتیفیکیشن؛ با لمس، تیک‌زدن چند دسته + توضیح کوتاه. تقسیم مبلغ: **مساوی خودکار**.
- ⬜ **دسته‌بندی چندتایی** + گزارش روزانه/هفتگی/ماهانه‌ی هر دسته
- ⬜ **گزارش زیبا:** نمودار + جدول + **خروجی PDF**
- ⬜ نمایش «کدام شخص» و «کدام کارت/حساب» روی تراکنش‌ها (مدل حساب/کارت خانواده)
