...
- 🔄 **نوتیفیکیشن دسته‌بندی:** بعد از تراکنش نوتیفیکیشن؛ با لمس، `CategorizeScreen` باز شود (در حال انجام)
- ⬜ **گزارش زیبا:** نمودار (pie/bar) + **خروجی PDF** (فعلاً نوار نسبت ساده هست)
