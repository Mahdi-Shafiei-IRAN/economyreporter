...
- ⬜ **SMS Receiver** (خواندن خودکار پیامک) — قدم بعدی؛ فعلاً پیامک دستی در «افزودن پیامک»

## فازهای بعدی (خلاصه — جزئیات در docs/roadmap.md)
- ⬜ SMS Receiver (خواندن خودکار پیامک) — روی گوشی تست می‌شود
- 🔒 فاز ۷ (تکمیل): سرشماره‌های عددی بانک‌ها — نیازمند نمونه‌ی بیشتر کاربر
