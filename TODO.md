...
- ✅ **افزودنی‌های پارسر + هارنس رگرسیون (۱۶ تست، مجموع موبایل: ۸۵ پاس)**
  ...
  - ⏳ **مانده تا نمونه‌ی واقعی:** پرکردن سرشماره‌های عددی بانک‌ها، کالیبره‌ی Regex با قالب واقعی، تبدیل واحدِ «مانده»ی تومانی، دسته‌بندی خودکار
  - 📌 وقتی نمونه رسید: فقط فایل json (با کارت ماسک‌شده) در پوشه‌ی fixtures اضافه/اصلاح می‌شود
