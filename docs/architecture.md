...
> **نسخه‌ی ۲ (مصوب):** هسته‌ی تراکنش‌ها طبقِ `docs/v2-design.md` بازنویسی می‌شود (دفترِ حساب با تأییدِ کاربر).
> بخش‌های مربوط به ثبتِ خودکارِ پیامک، تعمیر و ضدتکرارِ این سند تا پایانِ فازِ ۵ فقط برای نسخه‌ی ۱ معتبرند.
